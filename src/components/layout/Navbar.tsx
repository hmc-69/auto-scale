...
export const Navbar = () => {
  ...
  return (
    <header 
      className={`fixed top-0 left-0 right-0 z-50 transition-layout duration-500 ${
        scrolled ? 'bg-oceanic/70 backdrop-blur-xl border-b border-mint/10 py-4 shadow-lg' : 'bg-transparent py-6 border-b border-transparent'
      }`}
    >
      ...
      {/* Mobile Nav Overlay */}
      <div 
        className={`fixed inset-0 bg-oceanic/95 backdrop-blur-xl z-40 md:hidden transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] flex flex-col pt-28 px-6 ${
